	<?php include_once("../../functions/header.php"); ?>
          ...
          <ul class="scroll-buhne-element">
        		...
        		<li class="scroll-buhne-item">
        			...
        			<div class="scroll-buhne-item__text balance-text">
        				<h2 class="balance-text">Kosmos&shy;kopien<br> </h2>
        ...
        " preload="metadata" playsinline="" muted=""></video>
        			...
        			<div class="scroll-buhne-item__text balance-text">
        				<h2 class="balance-text">CC: World</h2>
        ...
        <p class="balance-text">	Projektwebsite online ansehen</p>
        		...
        		<li class="scroll-buhne-item">
        			...
        			<div class="scroll-buhne-item__text">
        				<h2 class="balance-text">The Sound of Distance</h2>
        				<p class="scroll-buhne-item__subtitle balance-text">Neue Ideen für Musik, Raum und Architektur</p>
...
<section class="add-gradient color-calendar-gradient element programmteaser-kalender-element">
		<div class="programmteaser-kalender-element-slideshow">
			...
			<div class="programmteaser-kalender-item">
				...
				<div class="programmteaser-kalender-item__datum">Morgen 16.Juli</div>
					...
					<p><span class="icon-extern"></span> Akademie der Künste</p>
				</a>
			</div>
			<div class="programmteaser-kalender-item">
				<a href="#">
...
<!-- Teaser mit Verläufen -->
	...
	<ul class="teaser-item-element">
		...
		<li class="teaser-item add-gradient width-50">
			 <a href="#">
				...
				<div class="teaser-item__text">
						...
						<h2 class="teaser-item__title">Digital Violence</h2>
				...
				<div class="teaser-item__visual">
				 ...
				 <div class="teaser-item__text">
					 <p class="teaser-item__topline">5. Juli <span class="icon-separator"></span> Online-Programm: Vortrag und Screenings</p>
						<h2 class="teaser-item__title">New Alphabet School: #Survivance</h2>
		...
		<li class="teaser-item add-gradient color4 width-50">
			<a href="#">
				...
				<div class="teaser-item__text">
					...
					<h2 class="teaser-item__title">Kosmoskopien</h2>
		...
		<li class="teaser-item add-gradient color3 width-50">
			...
			<div class="teaser-item__text">
				...
				<h2 class="teaser-item__title">Band 6: Carrier Bag Fiction</h2>
		...
		<li class="teaser-item add-gradient color8 width-50">
			<a href="#">
				...
				<div class="teaser-item__text">
					...
					<h2 class="teaser-item__title">Betonwalks</h2>
		...
		<li class="teaser-item add-gradient color1 width-50">
			...
			<h2 class="teaser-item__title">Bildungsschock: Vermittlung</h2>
	...
	<li class="teaser-item add-gradient color9 width-50">
		...
		<div class="teaser-item__text">
			...
			<h2 class="teaser-item__title">Surviving</h2>
